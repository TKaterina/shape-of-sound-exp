...
expName = 'instruments1'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\ktamp\\OneDrive\\Desktop\\instruments_exp\\instruments1_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text='You will be presented with two tones and will have to make judgements about how similar they are using a slider. Please pay attention to both tones, as you will need to compare them to each other. \n\nPress any key to proceed. ',
    font='Arial',
...
text_8 = visual.TextStim(win=win, name='text_8',
    text='How different are the two sounds? ',
    font='Arial',
...
_key_resp_2_allKeys = []
# keep track of which components have finished
questionsComponents = [text_7, key_resp_2]
...
while continueRoutine and routineTimer.getTime() < 3.0:
    ...
    if text_6.status == STARTED:  # only update if drawing
        text_6.setText(str(3-int(t)), log=False)
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('instruments.xlsx'),
...
for thisTrial in trials:
    ...
    routineForceEnded = False
    # update component parameters for each repeat
    sound_2.setSound(instrument1, secs=1.0, hamming=True)
    sound_2.setVolume(1.0, log=False)
    sound_3.setSound(instrument2, secs=1.0, hamming=True)
    sound_3.setVolume(1.0, log=False)
    # keep track of which components have finished
    trialComponents = [text_3, sound_2, sound_3, text_8]
    ...
    while continueRoutine and routineTimer.getTime() < 3.0:
        ...
        if sound_2.status == STARTED:
            ...
            if tThisFlipGlobal > sound_2.tStartRefresh + 1.0-frameTolerance:
                ...
                sound_2.stop()
        # start/stop sound_3
        if sound_3.status == NOT_STARTED and tThisFlip >= 2-frameTolerance:
            # keep track of start time/frame for later
    ...
    slider.reset()
    # keep track of which components have finished
    responseComponents = [text_2, slider]
